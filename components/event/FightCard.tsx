...
export function FightCardItem({
  ...
  return (
    <>
      <div className={cn(
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {odds && (
                <span className={cn(
                  ...
                  odds.fighter1.americanOdds < 0 ? "text-green-400/70" : "text-blue-400/70"
                )}>
            ...
            <div className="flex-1 min-w-0 text-right">
              ...
              {odds && (
                <span className={cn(
                  "text-xs font-mono font-semibold mt-1 block",
                  odds.fighter2.americanOdds < 0 ? "text-green-400/70" : "text-blue-400/70"
                )}>
          ...
          <div
            ...
            onClick={(e) => e.stopPropagation()} // don't expand card when clicking slip btn
          >
            <button
              ...
              className={cn(
                ...
                inSlip
                  ...
                  : "border-white/12 bg-white/[0.04] text-white/50 hover:border-[#D20A0A]/40 hover:bg-[#D20A0A]/8 hover:text-white/80"
              )}
            >
              {inSlip ? (
                <>
        ...
        {expanded && (
          <div className="border-t border-white/6 animate-fade-in-up">
            ...
            {/* Odds detail block — shown when expanded + odds available */}
            {odds && (
              <div className="px-4 sm:px-5 pb-4">
                <div className="rounded-xl border border-white/6 bg-white/[0.02] p-3.5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {/* Fighter 1 odds */}
                    <div>
                      <p className="text-white/50 text-xs font-semibold mb-1 truncate">{fighter1.name}</p>
                      <p className={cn(
                    ...
                    <div className="text-right">
                      <p className="text-white/50 text-xs font-semibold mb-1 truncate">{fighter2.name}</p>
                      <p className={cn(
                        "text-base font-black font-mono",
      ...
      {/* Fight pick modal — portal rendered above everything */}
      {pickModalOpen && (
        <FightPickModal
          fight={fight}
          eventName={eventName}
